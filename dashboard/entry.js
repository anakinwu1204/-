...
function render(data){
 const l=data.latest,m=l.metrics,above=m.distance_ma60_pct>0,slope=m.ma60_slope_20d_pct>0,momentum=m.return_20d_pct>=-5&&m.return_20d_pct<=8,passed=[l.total<=35,above,slope,momentum].filter(Boolean).length,statusEmoji=passed===3?'💡 ':passed===0?'⚠️ ':'';
