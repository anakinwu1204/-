...
const groupsByIndustry={
 ...
 '紡織纖維':['機能紡織','紡織纖維其他'],
 '電器電纜':['電線電纜','電器電纜其他'],
 '化學生技醫療':['生技製藥','醫療器材','特用化學','化學其他','生技醫療其他'],
 '化學':['特用化學','化學其他'],
 '生技醫療':['生技製藥','醫療器材','生技醫療其他'],
 '玻璃陶瓷':['玻璃陶瓷','玻璃陶瓷其他'],
 '造紙':['造紙','造紙其他'],
 '鋼鐵':['鋼鐵','鋼鐵其他'],
 '橡膠':['輪胎橡膠','橡膠其他'],
 '汽車':['汽車整車','汽車零組件','汽車其他'],
 '半導體':['記憶體','半導體設備','IC設計','半導體其他'],
 '電子零組件':['PCB','ABF載板','CCL銅箔基板','被動元件','電子零組件其他'],
 '電腦及週邊設備':['AI伺服器','散熱','電腦及週邊設備其他'],
 '通信網路':['光通訊','網通','通信網路其他'],
 '電機機械':['重電','機器人','電機機械其他'],
 '光電':['面板','LED光電','光學鏡頭','光電其他'],
 '電子通路':['半導體通路','電子通路其他'],
 '資訊服務':['資安','系統整合','資訊服務其他'],
 '其他電子':['電子檢測','設備工程','機器人','其他電子其他'],
 '建材營造':['營建','建材營造其他'],
 '航運':['貨櫃航運','散裝航運','航空','航運其他'],
 '觀光餐旅':['飯店餐旅','觀光餐旅其他'],
 '金融保險':['金控銀行','保險','金融保險其他'],
 '貿易百貨':['百貨零售','貿易百貨其他'],
 '油電燃氣':['石化能源','油電燃氣其他'],
